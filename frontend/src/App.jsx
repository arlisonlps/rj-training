...
import AlunosLista from './pages/admin/AlunosLista'
import AlunoForm from './pages/admin/AlunoForm'
import AlunoVisualizar from './pages/admin/AlunoVisualizar'
import Treinos from './pages/admin/Treinos'
import TreinoHorario from './pages/admin/TreinoHorario'
